...
HD_PWD='C:/Uni/Vivado/Lab9_4bitRegsWorking/Lab9_4bitRegsWorking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MasterNanoProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MasterNanoProcessor.tcl
